...
tape( 'the function has an arity of 2', function test( t ) {
	t.strictEqual( maxf.length, 2, 'accepts two arguments' );
	t.end();
});
...
tape( 'the function returns `+infinity` if provided `+infinity`', function test( t ) {
	...
	v = maxf( PINF, 3.14 );
	t.strictEqual( f32( v ), PINF, 'returns expected value' );
...
tape( 'the function returns the maximum value', function test( t ) {
	...
	v = maxf( f32( 4.2 ), f32( 3.14 ) );
	t.strictEqual( f32( v ), f32( 4.2 ), 'returns expected value' );
